                    ...
                    <a href='index.php' class='nav-item nav-link'>Home</a>
                        ...
                        <div class='nav-item dropdown'>
                         ...
                         <a href='contact.html' class='nav-item nav-link'>Help</a>
                             <center> <a href='cart.php'  class='btn btn-sm p-0' style='color:green;margin-top:25px;'><i class='fa fa-shopping-cart' aria-hidden='true'></i>
                        </a></center>
                    </div>
...
$allphones = array();
                       ...
                       while ($pp_price = mysqli_fetch_array($run_pro_price)) {
                           ...
                           while ($rows = mysqli_fetch_array($runa_query)) {
                              ...
                              <td  data-label='Track Order'> <a href='productinfo.php?id=$id' class='btn btn-primary' style='color:white;'><b>View Deatils</b></a> </td> 
...
<div id='accpted5'>
    ...
    ";
        ...
        if($no==0){
          ...
          echo"
          <script>alert('Order in Process');</script>";
          ...
          <script>document.getElementById('accpted1').innerHTML=` <div class='tracking-item' >
                ...
                document.getElementById('accpted').innerHTML=`  <div class='tracking-item' >
                  ...
                  <div class='tracking-date'><img src='https://raw.githubusercontent.com/shajo/portfolio/a02c5579c3ebe185bb1fc085909c582bf5fad802/delivery.svg' class='img-responsive' alt='order-placed' /></div>
                  <div class='tracking-content'>Order Placed <span>  $aaridate <br>  </span></div>
                </div>`; 
              ...
              <div class='tracking-date'><img src='https://raw.githubusercontent.com/shajo/portfolio/a02c5579c3ebe185bb1fc085909c582bf5fad802/delivery.svg' class='img-responsive' alt='order-placed' /></div>
              <div class='tracking-content'>Order Reached At delivary place  $address<span> Within 10 days <br>
             <form name='my-form' action='checkorder.php?id= $product_id11' method='post' enctype='multipart/form-data'>
            ...
            '  name='confirm3' value='Recived order'> Recive Order </button> </form>  </span></div>
            </div>`;
...
if (isset($_POST['confirm3'])) {
    ...
    $query11= "update orders 
              set no = 4, apdp = 'Order Reached At Buyer',delivadate=' $currentDateTime2 '
              where phonenumber=$product_id11";
    $run = mysqli_query($con, $query11);

    
    $query12= "update orderlist 
    set status = 'Order Reached At Buyer',sid = 4 
    where order_id=$product_id11";
$run2 = mysqli_query($con, $query12);


    echo "<script>window.open('checkorder.php?id=$product_id11','_self')</script>";
...
if (isset($_POST['cancel'])) {
    ...
    $query11= "update orders 
              set no = 5, apdp = 'Order Canceled by Buyer'
              where phonenumber=$product_id11";
    $run = mysqli_query($con, $query11);


    $query12= "update orderlist 
    set status = 'Order Canceled by Buyer',sid = 5 
    where order_id=$product_id11";
$run2 = mysqli_query($con, $query12);
