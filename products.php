...
<center>
<diV >
    <a href="insertpro.php">
<button type="button" class="btn btn-primary " name="search" style="height: 60px;width:240px;">Add New Product <i class='fa fa-plus'></i></button>
</a> 
</diV>
...
echo"<script> window.open('products.php?product=$item','_self')</script>";
}?>
                  </div>
                  </center>
...
<a href='productdeatils.php?id=$id' class='btn btn-primary rounded-pill py-2 px-4 m-2'>More Detail <i class='fa fa-arrow-right ms-2'></i></a>
