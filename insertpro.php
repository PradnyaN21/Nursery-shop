        ...
        <div class="container">
            ...
            <div class="row ">
                <div class="col wow fadeInUp" data-wow-delay="0.1s">
                        <form name="my-form" action="insertpro.php" method="post" enctype="multipart/form-data">
                        <div class="row g-3">
                   
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <h6 class="mb-4">Name Of Product:</h6>
                                    <input type="text" class="form-control" id="name" name="product_title" placeholder="Your Name">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <input type="number" class="form-control" id="email" name="product_price" placeholder="Your Email">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <input type="number" class="form-control" id="email" name="product_stock" placeholder="Your Email">
...
<br>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a message here" id="message" name="product_desc" style="height: 120px"></textarea>
...
<br>
<br>
    <textarea type="text"  class="form-control" id="myInput" name="key" height="120px" ></textarea>
...
if (isset($_POST['insert'])) {    // when button is clicked
    ...
    $product_image_tmp = $_FILES['product_image']['tmp_name'];  // for server
        ...
        $getting_id = "select * from plants";
        $run = mysqli_query($con, $getting_id);
        $row = mysqli_fetch_array($run);
        $id = $row['farmer_id'];
        $insert_product = "insert into plants (name,type,description,price,img,stock) 
                                values ('$product_name','$product_type','$product_desc','$product_price','$product_image','$product_stock')";

        $insert_query = mysqli_query($con, $insert_product);
        echo $insert_product;
        if ($insert_query) {
            echo "<script>alert('Product has been added')</script>";
            echo "<script>window.open('insertpro.php','_self')</script>";
        } else {
