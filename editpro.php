    ...
    <div class='container'>
        ...
        <div class='row '>
            <div class='col wow fadeInUp' data-wow-delay='0.1s'>
                    <form name='my-form' action='editpro.php?id=$id' method='post' enctype='multipart/form-data'>
                    <div class='row g-3'>
               
                        <div class='col-md-6'>
                            <div class='form-floating'>
                                <h6 class='mb-4'>Name Of Product:</h6>
                                <input type='text' class='form-control' id='name' name='product_title' value='$name'placeholder='Your Name'>
                              
                            </div>
                        </div>
                        <div class='col-md-6'>
                            <div class='form-floating'>
                                <h6 class='mb-4'>Insert Price Of Product (per Pic):</h6>
                                <input type='number' class='form-control' id='email' name='product_price' placeholder='Your Email' value='$price'>
                        ...
                        <div class='col-md-6'>
                            <div class='form-floating'>
                                ...
                                <input type='number' class='form-control' id='email' name='product_stock' placeholder='Your Email' value='$stock'>
...
<br>
                        ...
                        <div class='col-12'>
                            <div class='form-floating'>
                                <h6 class='mb-4'>Description For Product:</h6>
                                <textarea class='form-control' placeholder='Leave a message here' id='message' name='product_desc' style='height: 120px'>$desc</textarea>
                        ...
                        <div class='col-md-12'>
                            <div class='form-floating'>
                                <h6 class='mb-4'>Use For:</h6>
                                <select id='mySelect'>
                                
    <option value='Flower Plants'>Flower Plants</option>
    <option value='Indoor Plants'>Indoor Plants</option>
    <option value='Crotons'>Crotons</option>
    <option value='Pot Plants Online'>Pot Plants Online</option>
    <option value='Hanging And Creeper Plants'>Hanging And Creeper Plants</option>
    <option value='Cambo'>Cambo</option>
    <option value='Fertilizer And Seeds'>Fertilizer And Seeds</option>
    <option value='Planters'>Planters</option>
    <option value='Fruit And Tree'>Fruit And Tree</option>
</select>
<br>
<br>
<textarea type='text'  class='form-control' id='myInput' name='key' height='120px'>$type</textarea>

<script>// Get references to the select and input elements
...
// Append the selected value to the input field
inputElement.value += selectedValue + ' ,';
                        ...
                        <div class='col-12'>
                            <div class='form-floating'>
                                <h6 class='mb-4'>Insert Photos Of Product:</h6>
...
<input type='text' class='form-control' id='myText' name='newpho' placeholder='Your Email' value='no' hidden>
                                  <img src='Admin/product_images/$photo' class='d-flex mx-auto btn-dark image'style='margin-top: 20px;' height='250px;' width='340px;'>
                               <br>
                            </div>
                        </div>
                     <br>
...
if (isset($_POST['insert'])) {    // when button is clicked
    ...
    $removeimg="Admin/product_images/".$photo;
    unlink($removeimg);
        ...
        $insert_product = "update plants set name='$product_name',type='$product_type',description='$product_desc',price='$product_price',img='$product_image',stock='$product_stock'
                                where id='$product_id'";
 ...
 echo "<script>window.open('productdeatils.php?id=$id','_self')</script>";
        } else {
    ...
    $product_stock = $_POST['product_stock'];
        ...
        $insert_product = "update plants set name='$product_name',type='$product_type',description='$product_desc',price='$product_price',stock='$product_stock'
                                where id='$product_id'";
