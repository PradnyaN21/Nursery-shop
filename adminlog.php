    ...
    <div class="container-fluid product py-5">
        <div class="container py-5">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-medium fst-italic text-primary">LOG-IN ADMIN</p>
                <h1 class="display-6">Welcome Admin</h1>
            </div>
            <center>
            <form name="my-form" action="adminlog.php" method="post" enctype="multipart/form-data">
        ...
        <div style="position: relative;">
            ...
            <button type="button" id="togglePassword" style="
                ...
                Show
                            ...
                            <div class="col-md-6" style="margin-top:20px;">
                                <div class="form-floating">
                                <h6 class="display-7">Back To  <a href="index.php">Home</a> </h6>
                                </div>
                            </div>
...
<?php 
 ...
 if (isset($_POST['insert'])) { 
    ...
    $_SESSION['adminnumber'] = $phonenumber;  // Set session
