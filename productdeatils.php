                    ...
                    <div class='row'>
                        ...
                        <div class='col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 block border border-dark'>
                            ...
                            <br>
                               ...
                               <br>
                                ...
                                <br>
                                                          <a href='editpro.php?id=$id' class='btn btn-primary border-secondary  chat' style='color:black;margin-left:35px; margin-buttom:50px; background-color:#B3CC2E;'><b>Edit Product </b><i class='fa fa-tree' style='font-size:17px; '></i></a>
                        ...
                        <div class='col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 text-white' style='background-color:#292b2c;'>
                            ...
                            <div class='details mt-1 text-center'>
                                 <h4 style='color:green' class='text-center '>Want To Delete Product ? <i class='fa fa-arrow-down' ></i> <br></h4>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-12 col-xl-12 col-lg-6 col-md-6 col-sm-12'> 
                                            ...
                                            <button name='delete' type='submit'  class='btn btn-primary border-secondary addtocart' style='color:black;margin-left:35px; margin-buttom:50px; background-color:red;'><b>DELETE PRODUCT</b></button>
...
$sql="delete from plants where id=$product_id";
$run_query = mysqli_query($con,$sql);

$delete_product2 = "delete from cart where productid =$product_id";
$run_delete2 = mysqli_query($con, $delete_product2);


$delete_product3 = "delete from orders where product_id =$product_id";
