...
<body>
    ...
    <div class="box">
        <form action="forgotpassword.php" method="post">
            ...
            <input type="text" class="inp" name="pan" placeholder="Security Code (6 Digit)" required><br>
        ...
        <br>
            <input type="submit" name="register" class="btn btn-light rounded-pill py-3 px-5 " style="background-color:rgba(136, 180, 78, .7);color:white;"  value="Update Password">
        </form>
    </div>
...
if (isset($_POST['register'])) {
    ...
    $query = "select * from users where number = '$phonenumber' and scode = '$pan'";
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        if ($count_rows != 0) {
            $update_query = "update users set password = '$password' 
                                    where number = '$phonenumber' and scode = '$pan'";
