...
?>
    ...
    <div class='container py-5'>
        ...
        <center>
        <form name='my-form' action='editprofile.php?ph=<?php $no=$_SESSION['phonenumber']; echo"$no";?>' method='post' enctype='multipart/form-data'>
        <div class='col-md-6' >
                            <div class='form-floating'>
                            <h6 class='display-7'>Name:</h6>
                                <input type='text' class='form-control' id='email' name='uname' value='<?php echo"$name"?>' placeholder='Enter PassWord Number' >
                        ...
                        <div class="col-md-6" style="margin-top:20px;">
                            ...
                            <h6 class="display-7">State:</h6>
                                        <select name="statevalue" id="states" onchange="state()" class="form-control border border-dark" aria-selected="true">
                        ...
                        <div class='col-md-6' style='margin-top:20px;'>
                            ...
                            <h6 class='display-7'>Address:</h6>
                                <input type='text' class='form-control' id='email' name='address' value="<?php echo"$add"?>" placeholder='Enter PassWord Number' >
                        ...
                        <div class='col-md-6' style='margin-top:20px;'>
                            ...
                            <h6 class='display-7'>Password:</h6>
                                <input type='text' class='form-control' id='email' name='pass' value="<?php echo"$pass"?>" placeholder='Enter PassWord Number' >
                        ...
                        <div class='col-md-6' style='margin-top:20px;'>
                            ...
                            <h6 class='display-7'>Security Code(for forget password):</h6>
                                <input type='number' class='form-control' id='email' name='scode' pattern='[0-9]{4}' value="<?php echo"$scode"?>" maxlength='4' placeholder='Enter PassWord Number'>
                                
                            </div>
                        </div>
                      
                        <div class='col-12' style='margin-top:20px;'>
                        <button class="btn btn-primary rounded-pill py-3 px-5" type="submit" name="insertuser">EDIT</button>
                            </div>
            </form>
                            </center>
        </div>
...
<?php 
 ...
 if (isset($_POST['insertuser'])) { 
    ...
    $insert_product = "update users  
    set name='$name',address='$address',state='$state',dis='$dis',password='$pass',scode='$scode' 
    where number=$number ";
...
echo "<script>window.open('myprofile.php?ph=$number','_self')</script>";
} else {
